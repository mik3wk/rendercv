...
\begin{document}
    ...
    \section{Experience}
        ...
        1 year
            ...
            \begin{highlights}
                \item Developed, updated, and maintained key components of an enterprise resilience application, working with multiple microservices, micro frontends. This was done primarily through utilizing React, Node, Pulsar, PostgreSQL, and GraphQL. These services were designed to streamline and enhance business responses to catastrophic events, ensuring robust and efficient disaster management.
                \item Implemented algorithm to cluster business threats, grouping assessed risks and utilizing pub/sub with Pulsar to generate and store threat data in a database. This data was then accessed via GraphQL and visually represented on a map using React, providing a clear, actionable view of potential threats.
