    ...
    \section{Experience}
        ...
        2 years
            ...
            \begin{highlights}
                ...
                \item Implemented algorithm in collaboration with architechture to cluster business threats, utilizing pub/sub to generate and store threat data in a database; data was accessed via API and visually represented on a map using React, providing a clear, actionable view of potential threats.
